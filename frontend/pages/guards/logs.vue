  ...
  <div v-else>
    <v-card class="mb-5 mt-2 rounded-md" elevation="0">
      <v-toolbar class="rounded-md" dense flat>
        <v-toolbar-title><span> Guard Tracking Logs</span></v-toolbar-title>
        <v-col
          ><span>
            <v-btn
              dense
      ...
      <v-data-table
          ...
          <v-row no-gutters>
            ...
            >
              <v-img
                ...
                "
                :src="
                  item.guarduser.profile_picture
                    ? item.guarduser.profile_picture
            ...
            <!-- <v-col style="padding: 10px">
              ...
              {{
                item.user.guarduser
                  ? item.user.guarduser.first_name +
                    " " +
                    item.user.guarduser.last_name
                  : ""
        ...
        <template v-slot:item.employee.first_name="{ item, index }">
          <div v-if="item.guarduser">
            {{
              item.guarduser
                ? item.guarduser.first_name + " " + item.guarduser.last_name
                : ""
            }}
          </div>
